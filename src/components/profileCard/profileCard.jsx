                ...
                <Card className="profile-card">
                    ...
                    <Card.Body className="text-center " >
                        ...
                        <Row className="text-center mb-1">
                            <Col>
                                <Card.Text className='profile-text-bold'>{user.stories}</Card.Text>
                                <Card.Text className='profile-text-light'>Stories</Card.Text>
                            </Col>
                            <Col>
                                <Card.Text className='profile-text-bold' >{user.followers}</Card.Text>
                                <Card.Text className='profile-text-light'>Followers</Card.Text>
                            </Col>
                            <Col>
                                <Card.Text className='profile-text-bold '>{user.following}</Card.Text>
